    ...
    class Mail {
        static function sendNewRegMail($address, $firstName, $lastName, $reg_key, $lang) {
            ...
            try {
                ...
                $body_html_en = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><style>body {font-family:"Helvetica",sans-serif;font-size:16px;}a{text-decoration:none;border-bottom:1px solid #184C85;color:#184C85;transition:all 0.1s ease;}a:hover{border-bottom-color:transparent;}</style></head>Dear %firstName%,<br><br>thank you for registering to the 3rd Future Symphony Competition! To complete your registration, please follow this link:<br><br><a href="%reg_link%">%reg_link%</a><br><br>The submitted information can be revised during the whole registration period. Do not share this link with others.<br><br>Greetings from the FSC team!</html>';
