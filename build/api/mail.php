<?php
    ...
    function sendNewRegMail($address, $firstName, $lastName, $reg_key, $lang) {
        ...
        try {
            ...
            $body_html_lt = "Sveiki,<br><br>Dėkojame, kad užsiregistravote į III-ąjį „Future Symphony“ konkursą. Norėdami užbaigti registraciją, spustelėkite šią nuorodą:<br><br><a href='%reg_link%'>%reg_link%</a><br><br>Pagarbiai<br>FSC komanda";
